...
class Companion_Plugin {
  ...
  public static function companion_disable_popup(){
      ...
      update_option( "mesmerize_companion_disable_popup", $value );
  }
    ...
    if (!$plugin_state['installed'] || !$plugin_state['active']) {
        ...
        if (!$plugin_state['installed']) {
            $wp_customize->add_control(
                new Install_Companion_Control($wp_customize, 'mesmerize_page_content',
                    array( 
            ...
            $wp_customize->add_control(
                new Activate_Companion_Control($wp_customize, 'mesmerize_page_content',
                  array( 
                      'section'  => 'page_content',
                      'settings' => 'companion_install',
